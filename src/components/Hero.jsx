        ...
        {showPopup ? (
          <div className="purchase-popup">
            ...
            <div className="popup-text">
              ...
              <div className="popup-product">Hydratant Peau Sèche</div>
              <div className="popup-time">Il y a 13 minutes · Paris, France</div>
            </div>
            <button className="popup-close" onClick={() => setShowPopup(false)} aria-label="Fermer">✕</button>
          </div>
        ) : null}
      </div>
    </section>
